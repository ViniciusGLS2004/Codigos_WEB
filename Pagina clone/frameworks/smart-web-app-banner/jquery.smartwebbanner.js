...
;(function($){
	$.fn.smartWebBanner = function(options){
		...
		function createBanner(){
			$('body').append('<div id="smartWebBanner"><a href="#" id="swb-close">X</a><a href="#" id="swb-icon"></a><div id="swb-info"><strong>'+opts.title+'</strong><span>'+opts.author+'</span></div><a href="#" id="swb-save">Salve</a></div><div id="swb-instructions">Toque <span class="icon"></span> e depois <strong>adicione à tela inicial.</strong><div class="arrow"></div></div>');
			if(iPad){
				$('#smartWebBanner,#swb-instructions').addClass('ipad');
			}
			if(!iPad && !iPhone){
				$('#swb-instructions').html('<strong>Parece que este não é um dispositivo iOS.</strong> Este é um pop-up do iPhone.');
			}
			if(opts.showFree){
